				...
				<div className="row g-4 mb-4 pt-2">
					...
					<div className="col-lg-2 col-md-4 col-6">
						...
						<ul className="list-unstyled footer-links-list d-flex flex-column gap-2 fs-6">
							<li><Link to="/shop?category=helmets&q=Helmets" className="text-decoration-none text-muted">Helmets</Link></li>
							<li><Link to="/shop?category=jackets&q=Riding%20Jackets" className="text-decoration-none text-muted">Riding Gear</Link></li>
							<li><Link to="/shop?category=luggage&q=Luggage" className="text-decoration-none text-muted">Luggage Systems</Link></li>
							<li><Link to="/shop?category=crash&q=Crash" className="text-decoration-none text-muted">Bike Protection</Link></li>
							<li><Link to="/shop?category=exhausts&q=Exhausts" className="text-decoration-none text-muted">Performance Parts</Link></li>
						</ul>
					</div>
					...
					<div className="col-lg-3 col-md-4 col-6">
						...
						<ul className="list-unstyled footer-links-list d-flex flex-column gap-2 fs-6">
							<li><Link to="/shop" className="text-decoration-none text-muted">Track Order</Link></li>
							<li><Link to="/shop" className="text-decoration-none text-muted">Contact Us</Link></li>
							<li><Link to="/shop" className="text-decoration-none text-muted">Shipping Policy</Link></li>
							<li><Link to="/shop" className="text-decoration-none text-muted">Returns & Refunds</Link></li>
							<li><Link to="/shop" className="text-decoration-none text-muted">FAQs</Link></li>
						</ul>
					</div>
					...
					<div className="col-lg-3 col-md-4 col-12">
						...
						<ul className="list-unstyled footer-links-list d-flex flex-column gap-2 fs-6">
							<li><Link to="/shop" className="text-decoration-none text-muted">About Us</Link></li>
							<li><Link to="/shop" className="text-decoration-none text-muted">Store Locator</Link></li>
							<li><Link to="/shop" className="text-decoration-none text-muted">Blogs & Stories</Link></li>
							<li><Link to="/shop" className="text-decoration-none text-muted">Careers</Link></li>
							<li><Link to="/shop" className="text-decoration-none text-muted">Terms of Service</Link></li>
						</ul>
					</div>
				</div>
